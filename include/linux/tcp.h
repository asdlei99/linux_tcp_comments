 ...
 */
	...
	u32	copied_seq;	/* Head of yet unread data 接收未读数据开头的序列号		*/
	u32	rcv_wup;	/* rcv_nxt on last window update sent,窗口更新设置此值	*/
	...
	u32	snd_wl1;	/* Sequence for window update, 窗口更新的ACK序号		*/
 ...
 */
	...
	u32	fackets_out;	/* FACK'd packets, 记录的是SACK序号中最大的值吧？			*/
	u32	tso_deferred;
